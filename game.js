...
mui.plusReady(
	function() {
		document.getElementById('body').addEventListener('swipeleft', function() {
			//打开关于页面
			if(moveLeft()) {
		...
		document.getElementById('body').addEventListener('swiperight', function() {
			//打开关于页面
			if(moveRight()) {
				setTimeout("generateOneNumber()", 210);
				setTimeout("isgameover()", 300);
		...
		document.getElementById('body').addEventListener('swipeup', function() {
			//打开关于页面
			if(moveUp()) {
				setTimeout("generateOneNumber()", 210);
				setTimeout("isgameover()", 300);
		...
		document.getElementById('body').addEventListener('swipedown', function() {
			//打开关于页面
			if(moveDown()) {
				setTimeout("generateOneNumber()", 210);
				setTimeout("isgameover()", 300);
...
function gameover() {
	...
	gameover.css("width", "312px");
	gameover.css("height", "312px");
